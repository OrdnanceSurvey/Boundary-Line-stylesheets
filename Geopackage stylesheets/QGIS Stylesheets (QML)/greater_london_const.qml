...
<qgis simplifyLocal="1" version="3.4.1-Madeira" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" simplifyDrawingHints="1" maxScale="1000" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyMaxScale="1" labelsEnabled="1" readOnly="0" minScale="1e+06">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 forceraster="0" type="singleSymbol" symbollevels="1" enableorderby="0">
    <symbols>
  ...
  <labeling type="simple">
    <settings>
      <text-style fieldName="Name" fontLetterSpacing="0" fontFamily="Arial" useSubstitutions="0" fontSizeUnit="Point" namedStyle="Bold" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" previewBkgrdColor="#ffffff" textColor="0,0,0,255" multilineHeight="1" fontUnderline="0" fontSize="8" textOpacity="1" fontWeight="75" fontWordSpacing="0" blendMode="0" fontCapitals="0" isExpression="0">
        <text-buffer bufferSize="1.5" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferDraw="1" bufferBlendMode="0" bufferSizeUnits="MM" bufferNoFill="0" bufferOpacity="1"/>
      ...
      <placement offsetType="0" yOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" priority="4" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" repeatDistanceUnits="MM" centroidInside="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-20" quadOffset="4" rotationAngle="0" maxCurvedCharAngleIn="20" preserveRotation="1" fitInPolygonOnly="0" xOffset="0" offsetUnits="MM" placementFlags="0" distUnits="MM"/>
      <rendering obstacle="1" labelPerPart="0" upsidedownLabels="0" zIndex="0" mergeLines="0" fontMinPixelSize="3" fontMaxPixelSize="10000" drawLabels="1" displayAll="0" scaleVisibility="1" limitNumLabels="0" scaleMin="40000" fontLimitPixelSize="0" obstacleType="0" maxNumLabels="2000" minFeatureSize="0" obstacleFactor="1" scaleMax="250000"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
