...
<qgis simplifyLocal="1" version="3.4.1-Madeira" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" simplifyDrawingHints="1" maxScale="1000" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyMaxScale="1" labelsEnabled="1" readOnly="0" minScale="75000">
  <flags>
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{070aae0b-4083-4e89-8437-fbefbdad449d}">
      <rule key="{34e66c78-be36-456c-85d0-ec4295c1b696}" scalemindenom="1000" symbol="0" scalemaxdenom="50000"/>
    ...
    <symbols>
      <symbol clip_to_extent="1" type="fill" alpha="1" name="0">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop v="229,107,0,255" k="line_color"/>
  ...
  <labeling type="simple">
    <settings>
      <text-style fieldName="Name" fontLetterSpacing="0" fontFamily="Arial" useSubstitutions="0" fontSizeUnit="Point" namedStyle="Bold Italic" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="1" previewBkgrdColor="#ffffff" textColor="229,107,0,255" multilineHeight="1" fontUnderline="0" fontSize="10" textOpacity="1" fontWeight="75" fontWordSpacing="0" blendMode="0" fontCapitals="0" isExpression="0">
      ...
      <rendering obstacle="1" labelPerPart="0" upsidedownLabels="0" zIndex="0" mergeLines="0" fontMinPixelSize="3" fontMaxPixelSize="10000" drawLabels="1" displayAll="0" scaleVisibility="1" limitNumLabels="0" scaleMin="1000" fontLimitPixelSize="0" obstacleType="0" maxNumLabels="2000" minFeatureSize="0" obstacleFactor="1" scaleMax="50000"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" field="Census_Code" notnull_strength="0" unique_strength="0"/>
