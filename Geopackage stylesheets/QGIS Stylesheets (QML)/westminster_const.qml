...
<qgis simplifyLocal="1" version="3.4.1-Madeira" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" simplifyDrawingHints="1" maxScale="1000" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyMaxScale="1" labelsEnabled="1" readOnly="0" minScale="3.5e+06">
  <flags>
    ...
    <symbols>
      <symbol clip_to_extent="1" type="fill" alpha="1" name="0">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop v="1,52,117,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.5292" k="line_width"/>
  ...
  <labeling type="simple">
    <settings>
      ...
      <placement offsetType="0" yOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="1" priority="5" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" repeatDistanceUnits="MM" centroidInside="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-20" quadOffset="4" rotationAngle="0" maxCurvedCharAngleIn="20" preserveRotation="1" fitInPolygonOnly="0" xOffset="0" offsetUnits="MM" placementFlags="0" distUnits="MM"/>
      <rendering obstacle="1" labelPerPart="0" upsidedownLabels="0" zIndex="0" mergeLines="0" fontMinPixelSize="3" fontMaxPixelSize="10000" drawLabels="1" displayAll="0" scaleVisibility="1" limitNumLabels="0" scaleMin="10000" fontLimitPixelSize="0" obstacleType="0" maxNumLabels="2000" minFeatureSize="0" obstacleFactor="1" scaleMax="500000"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
