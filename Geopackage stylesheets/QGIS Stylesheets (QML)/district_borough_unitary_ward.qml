...
<qgis simplifyLocal="1" version="3.4.1-Madeira" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" simplifyDrawingHints="1" maxScale="1000" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyMaxScale="1" labelsEnabled="1" readOnly="0" minScale="200000">
  <flags>
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{350fc2f4-ac9f-4ba9-b9c7-af62d572b781}">
      <rule key="{0889d98e-4b66-4933-b8d3-6fb867dc636c}" scalemindenom="1000" symbol="0" scalemaxdenom="150000"/>
    ...
    <symbols>
      <symbol clip_to_extent="1" type="fill" alpha="1" name="0">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop v="60,60,60,255" k="line_color"/>
  ...
  <labeling type="simple">
    <settings>
      <text-style fieldName="Name" fontLetterSpacing="0" fontFamily="Arial" useSubstitutions="0" fontSizeUnit="Point" namedStyle="Regular" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" previewBkgrdColor="#ffffff" textColor="0,0,0,255" multilineHeight="1" fontUnderline="0" fontSize="7.5" textOpacity="1" fontWeight="50" fontWordSpacing="0" blendMode="0" fontCapitals="0" isExpression="0">
      ...
      <placement offsetType="0" yOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="1" priority="2" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="0" repeatDistanceUnits="MM" centroidInside="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-20" quadOffset="4" rotationAngle="0" maxCurvedCharAngleIn="20" preserveRotation="1" fitInPolygonOnly="0" xOffset="0" offsetUnits="MM" placementFlags="0" distUnits="MM"/>
      <rendering obstacle="1" labelPerPart="0" upsidedownLabels="0" zIndex="0" mergeLines="0" fontMinPixelSize="3" fontMaxPixelSize="10000" drawLabels="1" displayAll="0" scaleVisibility="1" limitNumLabels="0" scaleMin="1000" fontLimitPixelSize="0" obstacleType="0" maxNumLabels="2000" minFeatureSize="0" obstacleFactor="1" scaleMax="200000"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option type="Map" name="properties">
            <Option type="Map" name="Color">
              ...
              <Option type="QString" name="expression" value="CASE WHEN  &quot;AREA_CODE&quot; = 'DIW'  THEN  color_rgb( 158, 0, 0) WHEN  &quot;AREA_CODE&quot; = 'UTW' OR  &quot;AREA_CODE&quot; = 'MTW' OR &quot;AREA_CODE&quot; = 'LBW' THEN  color_rgb( 5, 117, 61) END"/>
              <Option type="int" name="type" value="3"/>
            </Option>
            <Option type="Map" name="MinimumScale">
              <Option type="bool" name="active" value="true"/>
              <Option type="QString" name="expression" value="CASE WHEN  &quot;AREA_CODE&quot;  =  'LBW'  THEN 100000 ELSE 200000 END"/>
              <Option type="int" name="type" value="3"/>
            </Option>
            <Option type="Map" name="MultiLineWrapChar">
              <Option type="bool" name="active" value="true"/>
              <Option type="QString" name="expression" value="CASE WHEN  length(  &quot;NAME&quot; ) > 19 THEN ' '  ELSE '  ' END"/>
              <Option type="int" name="type" value="3"/>
            </Option>
            <Option type="Map" name="Size">
              <Option type="bool" name="active" value="false"/>
              <Option type="QString" name="expression" value="CASE WHEN  &quot;AREA_CODE&quot;  =  'DIW'  THEN 9 WHEN  &quot;AREA_CODE&quot;  =  'UTW'  THEN 8   WHEN  &quot;AREA_CODE&quot;  =  'MTW'  THEN 7 WHEN  &quot;AREA_CODE&quot;  =  'LBW'  THEN 5 ELSE 6 END"/>
              <Option type="int" name="type" value="3"/>
            </Option>
          </Option>
          <Option type="QString" name="type" value="collection"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" lineSizeScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" penAlpha="255" height="15" penColor="#000000" minScaleDenominator="1000" penWidth="0" lineSizeType="MM" maxScaleDenominator="1e+08" minimumSize="0" width="15" backgroundColor="#ffffff" sizeType="MM" diagramOrientation="Up" opacity="1" rotationOffset="270" backgroundAlpha="255" enabled="0" scaleDependency="Area" barWidth="5">
