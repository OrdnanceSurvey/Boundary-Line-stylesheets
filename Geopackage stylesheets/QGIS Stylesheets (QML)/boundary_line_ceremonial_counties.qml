...
<qgis simplifyLocal="1" version="3.4.1-Madeira" hasScaleBasedVisibilityFlag="1" simplifyAlgorithm="0" simplifyDrawingHints="1" maxScale="150000" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyMaxScale="1" labelsEnabled="1" readOnly="0" minScale="1e+06">
  <flags>
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" symbollevels="0" enableorderby="0">
    <rules key="{7496d9e7-39fd-4168-8a51-cce65629790c}">
      <rule key="{42b8fa6c-b625-4581-88d4-419217ee4c52}" scalemindenom="70000" symbol="0" scalemaxdenom="750000"/>
      <rule key="{4602481a-70ac-4830-87c4-a85feb7d44b4}" scalemindenom="750000" symbol="1" scalemaxdenom="1000000"/>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings>
      <text-style fieldName="Name" fontLetterSpacing="0" fontFamily="Arial" useSubstitutions="0" fontSizeUnit="Point" namedStyle="Bold Italic" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="1" previewBkgrdColor="#ffffff" textColor="5,117,61,255" multilineHeight="1" fontUnderline="0" fontSize="11" textOpacity="1" fontWeight="75" fontWordSpacing="0" blendMode="0" fontCapitals="0" isExpression="0">
      ...
      <rendering obstacle="1" labelPerPart="0" upsidedownLabels="0" zIndex="0" mergeLines="0" fontMinPixelSize="3" fontMaxPixelSize="10000" drawLabels="1" displayAll="0" scaleVisibility="1" limitNumLabels="0" scaleMin="175000" fontLimitPixelSize="0" obstacleType="0" maxNumLabels="2000" minFeatureSize="0" obstacleFactor="1" scaleMax="750000"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" lineSizeScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" penAlpha="255" height="15" penColor="#000000" minScaleDenominator="150000" penWidth="0" lineSizeType="MM" maxScaleDenominator="1e+08" minimumSize="0" width="15" backgroundColor="#ffffff" sizeType="MM" diagramOrientation="Up" opacity="1" rotationOffset="270" backgroundAlpha="255" enabled="0" scaleDependency="Area" barWidth="5">
  ...
  <aliases>
    ...
    <alias field="Area_Description" index="2" name=""/>
  </aliases>
